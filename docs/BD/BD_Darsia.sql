...
idTitle INT UNSIGNED AUTO_INCREMENT NOT NULL,
name VARCHAR (25) NOT NULL,
description TEXT NOT NULL,
...
titleReq INT UNSIGNED,
cityReq INT UNSIGNED,
idNewMapSpot INT UNSIGNED NOT NULL,
...
CONSTRAINT FK_rSpotMap_NewMapSpot FOREIGN KEY (idNewMapSpot) REFERENCES Spot (idSpot)
);
...
CREATE TABLE IF NOT EXISTS rPjTitle (
idRPjTitle INT UNSIGNED AUTO_INCREMENT NOT NULL,
idPj INT UNSIGNED NOT NULL,
idTitle INT UNSIGNED NOT NULL,
CONSTRAINT PK_rPjTitle PRIMARY KEY (idRPjTitle),
CONSTRAINT FK_rPjTitle_Pj FOREIGN KEY (idPj) REFERENCES Pj (idPj),
CONSTRAINT FK_rPjTitle_Title FOREIGN KEY (idTitle) REFERENCES Title (idTitle)
);
